...
const QUIZ_BANK = [
  ...
  {
    topic: "ISN",
    question: "O antecessor direto do ISN na missão de salvamento marítimo costumava designar-se por:",
    correct: "Real Instituto de Socorros a Náufragos (RISN)",
    distractors: [
      "Instituto Nacional de Meteorologia",
      "Capitania dos Portos de Recreio",
      "Guarda Nacional Republicana — Coastal",
    ],
  },
  {
    topic: "ISN",
    question: "Qual o foco principal do Instituto de Socorros a Náufragos (ISN) em Portugal?",
    correct: "Prevenção e socorro em meio aquático costeiro e outras áreas de competência",
    distractors: [
      "Regulação do tráfego aéreo",
      "Exploração de portos comerciais",
      "Licenciamento de embarcações de pesca",
    ],
  },
  {
    topic: "ISN",
    question: "Em contexto de praia vigiada, o posto de vigia e primeiros socorros costuma estar associado a:",
    correct: "Equipa de nadadores-salvadores e meios do ISN",
    distractors: [
      "Apenas voluntários sem formação",
      "Empresas de catering",
      "Jurisdição exclusiva municipal sem coordenação",
    ],
  },
  {
    topic: "ISN",
    question: "A bandeira verde na praia indica geralmente:",
    correct: "Banho permitido, com vigilância ativa quando aplicável",
    distractors: ["Praia interditada", "Presença de medusas tóxicas", "Mau tempo sem vigilância"],
  },
  {
    topic: "ISN",
    question: "A bandeira vermelha na praia significa:",
    correct: "Banho proibido",
    distractors: ["Cuidado com correntes", "Praia sem vigilância mas permitida", "Apenas surf permitido"],
  },
  {
    topic: "ISN",
    question: "A bandeira amarela na praia indica habitualmente:",
    correct: "Banho condicionado / permitido com restrições",
    distractors: ["Banho livre sem limites", "Praia encerrada", "Somente pesca submarina"],
  },
  {
    topic: "ISN",
    question: "O ISN colabora frequentemente com outras entidades em operações de:",
    correct: "Busca e salvamento, apoio a autoridades e prevenção",
    distractors: [
  ...
  {
    topic: "ISN",
    question: "A sinalização balnear visa principalmente:",
    correct: "Informar e proteger os utentes da praia",
    distractors: [
      "Promover eventos noturnos",
      "Substituir regras de trânsito rodoviário",
      "Indicar horários de restaurantes",
    ],
  },
  {
    topic: "ISN",
    question: "Em caso de emergência na praia vigiada, o cidadão deve:",
    correct: "Alertar de imediato o nadador-salvador ou serviço de emergência (112)",
    distractors: [
      "Resolver sozinho sem comunicar",
      "Apenas publicar nas redes sociais",
      "Aguardar o fim do dia útil",
    ],
  },
  {
    topic: "ISN",
    question: "A prevenção de afogamentos é considerada:",
    correct: "Prioridade na atuação em meio aquático",
    distractors: [
      "Secundária face ao comércio local",
      "Responsabilidade exclusiva dos pais",
      "Apenas relevante em piscinas olímpicas",
    ],
  },
  {
    topic: "ISN",
    question: "O número europeu único de emergência é:",
    correct: "112",
    distractors: ["911", "999 exclusivo", "115"],
  },
  {
    topic: "ISN",
    question: "A vigilância em praia procura reduzir riscos como:",
    correct: "Afogamento, traumatismos e situações de perigo em água",
    distractors: ["Roubo de veículos", "Incêndios florestais interiores", "Falhas de rede elétrica"],
  },
  {
    topic: "ISN",
    question: "A informação sobre condições marítimas costuma ser relevante para:",
    correct: "Decidir com segurança se se deve ir à praia e como comportar-se",
    distractors: [
      "Escolher vinhos regionais",
      "Planeamento de obras em telhados",
      "Comprar bilhetes de comboio",
    ],
  },
  {
    topic: "ISN",
    question: "Posto de primeiros socorros na praia serve para:",
    correct: "Prestação de primeiros cuidados e encaminhamento médico",
    distractors: [
      "Venda de gelados exclusivamente",
      "Aluguer de guarda-sóis apenas",
      "Check-in de hotéis",
    ],
  },
  {
    topic: "ISN",
    question: "A educação para a segurança aquática inclui:",
    correct: "Regras de comportamento e reconhecimento de perigos",
    distractors: [
      "Apenas natação de competição",
      "Ignorar sinalização oficial",
      "Nadar sempre fora da zona vigiada",
    ],
  },
  {
    topic: "ISN",
    question: "Em operações coordenadas, a comunicação clara entre equipas evita:",
    correct: "Atrasos e erros que comprometem a segurança da vítima",
    distractors: [
  ...
  {
    topic: "ISN",
    question: "O respeito pelas instruções do nadador-salvador visa:",
    correct: "Proteger a vida e a integridade dos banhistas",
    distractors: [
      "Restringir o lazer sem motivo",
      "Substituir regras de estacionamento",
      "Promover multas automáticas",
    ],
  },
  {
    topic: "ISN",
    question: "A fiscalização balnear em sentido amplo contribui para:",
    correct: "Ambiente mais seguro e previsível para utentes",
    distractors: [
      "Eliminar o turismo",
      "Proibir crianças na areia",
      "Encerrar restaurantes",
    ],
  },
  {
    topic: "ISN",
    question: "A cultura de segurança na praia pressupõe:",
    correct: "Autoproteção, vigilância das crianças e cumprimento das regras",
    distractors: [
      "Nadar alcoolizado sem riscos",
      "Ignorar marés e vento",
      "Afastar-se sempre da equipa de vigilância",
    ],
  },
